...
/**
 * Generated from protobuf message <code>com.elarian.hera.proto.DeleteCustomerSecondaryIdCommand</code>
 */
class DeleteCustomerSecondaryIdCommand extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>repeated .com.elarian.hera.proto.IndexMapping deletions = 4;</code>
     */
    private $deletions;
    protected $customer;
     ...
     *     @type \Com\Elarian\Hera\Proto\IndexMapping[]|\Google\Protobuf\Internal\RepeatedField $deletions
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .com.elarian.hera.proto.IndexMapping deletions = 4;</code>
     * @param \Com\Elarian\Hera\Proto\IndexMapping[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setDeletions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Com\Elarian\Hera\Proto\IndexMapping::class);
        $this->deletions = $arr;
