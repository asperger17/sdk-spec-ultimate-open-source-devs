 ...
 **/
GPB_FINAL @interface AppStateRoot : GPBRootObject
@end

#pragma mark - AppState

typedef GPB_ENUM(AppState_FieldNumber) {
  AppState_FieldNumber_Data_p = 1,
  AppState_FieldNumber_RemindersArray = 2,
};

GPB_FINAL @interface AppState : GPBMessage

@property(nonatomic, readwrite, strong, null_resettable) DataMapValue *data_p;
/** Test to see if @c data_p has been set. */
@property(nonatomic, readwrite) BOOL hasData_p;

@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<CustomerReminder*> *remindersArray;
