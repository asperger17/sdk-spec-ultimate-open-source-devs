 ...
 **/
GPB_FINAL @interface ActivityModelRoot : GPBRootObject
@end

#pragma mark - CustomerActivity

typedef GPB_ENUM(CustomerActivity_FieldNumber) {
  CustomerActivity_FieldNumber_Key = 1,
  CustomerActivity_FieldNumber_Properties = 2,
  CustomerActivity_FieldNumber_CreatedAt = 3,
};

GPB_FINAL @interface CustomerActivity : GPBMessage
